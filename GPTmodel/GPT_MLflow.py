...
# hyperparameters
batch_size = 16  # Parallel sequencing
...
with mlflow.start_run(run_name="SGD with... honestly I didn't know I could increase the momentum this much") as run:
    mlflow.log_params({
...
# Main
user_input = "Johnny screamed"
generated_text = generate_text(user_input, max_new_tokens=200)
